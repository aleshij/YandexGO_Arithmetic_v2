...
---Установка---
Версия go - 1.21.
Создайте проект с именем "YandexGO_Arithmetic_v2" (без кавычек), скопируйте в него скаченные файлы. Установите зависимые пакеты. Рекомендую имеенно этот способ,
что бы избежать перенастройки проекта.
