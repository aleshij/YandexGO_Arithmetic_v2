...
---Запуск---
Для запуска сервера, запустите в IDE или скомпилируйте файл go build servergrpc.go расположенный в папке /server. 
Для запуска агента, запустите в IDE или скомпилируйте файл go build agentgrpc.go расположенный в папке /agent.
